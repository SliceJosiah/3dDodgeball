...
namespace _3dDodgeball
{
    internal class Render1
    {
        ...
        public void RenderGraphics(object sender, PaintEventArgs e)
        {
            ...
            {
                g.FillEllipse(Brushes.Black, Convert.ToSingle((enemies1.ball[i].ballX - enemies1.ball[i].ballRadius) * 100), game2.ClientSize.Height - Convert.ToSingle((enemies1.ball[i].ballY - enemies1.ball[i].ballRadius * 3 * ym) * 100 * ym), Convert.ToSingle(enemies1.ball[i].ballRadius * 200), Convert.ToSingle(enemies1.ball[i].ballRadius * 200 * ym));
